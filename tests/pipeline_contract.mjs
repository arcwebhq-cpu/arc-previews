...
const [template,injector,privateCheckout,privateCheckoutLifecycle,resolver,deliveryGate,wiringText,siteCore,siteService,siteStart]=await Promise.all([
  ...
  read(root,"zapier/arc1_private_checkout_lifecycle.js"),read(root,"zapier/arc2_resolve_and_finalize.js"),read(root,"zapier/arc2_delivery_email_gate.js"),read(root,"zapier/wiring-contract.json"),
...
for(const [name,source,args] of [
  ...
  ["paid resolver",resolver,["inputData","fetch","Buffer"]],
