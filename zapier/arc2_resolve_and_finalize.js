...
setCreate("line_items[0][price]",checkoutPolicy.price_id);setCreate("line_items[0][quantity]","1");setCreate("automatic_tax[enabled]","true");setCreate("billing_address_collection","required");
